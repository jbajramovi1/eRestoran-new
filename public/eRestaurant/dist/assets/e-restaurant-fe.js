...
define('e-restaurant-fe/components/add-restaurant', ['exports', 'e-restaurant-fe/models/restaurant', 'e-restaurant-fe/models/menu'], function (exports, _restaurant, _menu) {
  'use strict';
    ...
    actions: {
      addRestaurant: function addRestaurant() {
        ...
        this.get('adminService').addRestaurant(this.get('restaurantName'), this.get('restaurantDesc'), this.get('restaurantCategory')).done(function (response) {
          ...
          var menuBreakfast = _menu.default.create({});
          _this.get('adminService').addMenu('Breakfast', restaurant).done(function (response) {
            menuBreakfast.set('id', response.id);
            console.log('add');
            console.log(_this.get('breakfast'));
            console.log(_this.get('lunch'));
            for (item in _this.get('breakfast')) {
              _this.get('adminService').addMenuItem(item.name, item.price, item.description, menuBreakfast).fail(function (response) {
                _this.get('notifications').error('Error occured while adding restaurant menu item', {
                  autoClear: true,
                  clearDuration: 1500
                });
              });
            ...
            _this.get('notifications').error('Error occured while adding restaurant menu', {
              autoClear: true,
              clearDuration: 1500
            });
          });

          var menuLunch = _menu.default.create({});
          _this.get('adminService').addMenu('Lunch', restaurant).done(function (response) {
            menuLunch.set('id', response.id);
            for (item in _this.get('lunch')) {
              _this.get('adminService').addMenuItem(item.name, item.price, item.description, menuLunch).fail(function (response) {
                _this.get('notifications').error('Error occured while adding restaurant menu item', {
                  autoClear: true,
                  clearDuration: 1500
                });
          ...
          var menuDinner = _menu.default.create({});
          _this.get('adminService').addMenu('Dinner', restaurant).done(function (response) {
            menuDinner.set('id', response.id);
            for (item in _this.get('dinner')) {
              _this.get('adminService').addMenuItem(item.name, item.price, item.description, menuDinner).fail(function (response) {
                _this.get('notifications').error('Error occured while adding restaurant menu item', {
                  autoClear: true,
                  clearDuration: 1500
                });
      ...
      openTables: function openTables() {
        this.set('enableBasic', false);
        this.set('enableMenu', false);
...
define("e-restaurant-fe/components/restaurant-basic", ["exports"], function (exports) {
  "use strict";
...
define('e-restaurant-fe/components/restaurant-menu', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Component.extend({
    ...
    newBreakfast: function () {
      return this.get('breakfast').map(function (_ref) {
        var name = _ref.name,
...
define('e-restaurant-fe/components/restaurant-tables', ['exports'], function (exports) {
    'use strict';
...
define('e-restaurant-fe/models/menu', ['exports', 'e-restaurant-fe/models/base-model'], function (exports, _baseModel) {
    'use strict';
...
define('e-restaurant-fe/models/menuitem', ['exports', 'e-restaurant-fe/models/base-model'], function (exports, _baseModel) {
    'use strict';
    ...
    var _modelProperties = ['id', 'name', 'price', 'description', 'menu'];
...
define('e-restaurant-fe/services/admin-service', ['exports'], function (exports) {
  ...
  exports.default = Ember.Service.extend({
    ...
    addMenu: function addMenu(name, restaurant) {
      return $.ajax({
        method: 'POST',
    ...
    addMenuItem: function addMenuItem(name, price, description, menu) {
      return $.ajax({
        method: 'POST',
        url: '/api/v1/admin/menuitem',
        data: JSON.stringify({
          name: name,
          price: price,
          description: description,
    ...
    addRestaurantTable: function addRestaurantTable(sittingPlaces, restaurant) {
      return $.ajax({
        method: 'POST',
        url: '/api/v1/admin/restauranttable',
        data: JSON.stringify({
...
define('e-restaurant-fe/services/restaurant-service', ['exports', 'e-restaurant-fe/models/restaurant'], function (exports, _restaurant) {
  ...
  exports.default = Ember.Service.extend({
    ...
    createRestaurant: function createRestaurant(name, description, category, location, mark, votes) {
      return $.ajax({
        method: 'POST',
...
define("e-restaurant-fe/templates/components/add-restaurant", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "BjHKHsXu", "block": "{\"statements\":[[6,[\"if\"],[[28,[\"enabled\"]]],null,{\"statements\":[[11,\"div\",[]],[15,\"class\",\"add-restaurant-panel\"],[13],[0,\"\\n  \"],[11,\"div\",[]],[15,\"class\",\"add-restaurant-menu\"],[13],[0,\"\\n    \"],[11,\"ul\",[]],[15,\"class\",\"nav navbar-nav nav-add-restaurant\"],[13],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item\"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableBasic\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openBasic\"]],[13],[0,\"Basic details\"],[14],[14],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item\"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableMenu\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openMenu\"]],[13],[0,\"Menu\"],[14],[14],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item \"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableTables\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openTables\"]],[13],[0,\"Tables\"],[14],[14],[0,\"\\n    \"],[14],[0,\"\\n  \"],[14],[0,\"\\n  \"],[6,[\"restaurant-basic\"],null,[[\"enabled\",\"restaurantName\",\"restaurantDesc\",\"restaurantCategory\",\"restaurantLocation\",\"errorName\",\"errorDesc\",\"errorCategory\"],[[28,[\"enableBasic\"]],[28,[\"restaurantName\"]],[28,[\"restaurantDesc\"]],[28,[\"restaurantCategory\"]],[28,[\"restaurantLocation\"]],[28,[\"errorName\"]],[28,[\"errorDesc\"]],[28,[\"errorCategory\"]]]],{\"statements\":[],\"locals\":[]},null],[0,\"\\n  \"],[6,[\"restaurant-menu\"],null,[[\"enabled\",\"breakfast\",\"lunch\",\"dinner\"],[[28,[\"enableMenu\"]],[28,[\"breakfast\"]],[28,[\"lunch\"]],[28,[\"dinner\"]]]],{\"statements\":[],\"locals\":[]},null],[0,\"\\n  \"],[6,[\"restaurant-tables\"],null,[[\"enabled\",\"tables\"],[[28,[\"enableTables\"]],[28,[\"tables\"]]]],{\"statements\":[],\"locals\":[]},null],[0,\"\\n\\n  \"],[11,\"div\",[]],[15,\"class\",\"row-buttons\"],[13],[0,\"\\n  \"],[11,\"div\",[]],[15,\"class\",\"buttons-restaurant\"],[13],[0,\"\\n    \"],[11,\"button\",[]],[15,\"class\",\"button-add create-restaurant-btn\"],[5,[\"action\"],[[28,[null]],\"addRestaurant\"]],[13],[0,\"Add restaurant\"],[14],[0,\"\\n    \"],[11,\"button\",[]],[15,\"class\",\"button-add cancel-restaurant-btn\"],[5,[\"action\"],[[28,[null]],\"cancel\"]],[13],[0,\"Cancel\"],[14],[0,\"\\n  \"],[14],[0,\"\\n\"],[14],[0,\"\\n\\n\"],[14],[0,\"\\n\\n\"]],\"locals\":[]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "e-restaurant-fe/templates/components/add-restaurant.hbs" } });
});
...
define("e-restaurant-fe/templates/components/restaurant-basic", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "Vi6414vP", "block": "{\"statements\":[[6,[\"if\"],[[28,[\"enabled\"]]],null,{\"statements\":[[11,\"div\",[]],[15,\"class\",\"row-add-restaurant\"],[13],[0,\"\\n  \"],[11,\"div\",[]],[15,\"class\",\"col-add-restaurant col-left\"],[13],[0,\"\\n    \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par\"],[13],[0,\"Add Logo\"],[14],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"add-logo\"],[13],[0,\"\\n        \"],[11,\"a\",[]],[15,\"class\",\"add-logo-link\"],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"addFile\"]],[13],[0,\"\\n          \"],[11,\"div\",[]],[15,\"class\",\"glyphicon-div\"],[13],[11,\"span\",[]],[15,\"class\",\"glyphicon glyphicon-cloud-upload\"],[13],[14],[14],[0,\"\\n          \"],[11,\"p\",[]],[15,\"class\",\"logo-link\"],[13],[0,\"Upload Logo\"],[14],[0,\"\\n        \"],[14],[0,\"\\n      \"],[14],[0,\"\\n    \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par\"],[13],[0,\"Name\"],[14],[0,\"\\n    \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"restaurantName\"]],\"restaurant-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n    \"],[11,\"div\",[]],[15,\"class\",\"error error-admin\"],[13],[1,[26,[\"errorName\"]],false],[14],[0,\"\\n    \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par\"],[13],[0,\"Description\"],[14],[0,\"\\n    \"],[1,[33,[\"textarea\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"restaurantDesc\"]],\"description-input input-large\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n    \"],[11,\"div\",[]],[15,\"class\",\"error error-admin\"],[13],[1,[26,[\"errorDesc\"]],false],[14],[0,\"\\n  \"],[14],[0,\"\\n\\n  \"],[11,\"div\",[]],[15,\"class\",\"col-add-restaurant col-right\"],[13],[0,\"\\n\\n    \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par\"],[13],[0,\"Add Cover Photo\"],[14],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"add-cover\"],[13],[0,\"\\n        \"],[1,[33,[\"input\"],null,[[\"type\",\"id\"],[\"file\",\"files\"]]],false],[0,\"\\n        \"],[11,\"a\",[]],[15,\"class\",\"add-cover-link\"],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"addFile\"]],[13],[0,\"\\n\\n          \"],[11,\"div\",[]],[15,\"class\",\"glyphicon-div\"],[13],[11,\"span\",[]],[15,\"class\",\"glyphicon glyphicon-cloud-upload\"],[13],[14],[14],[0,\"\\n          \"],[11,\"p\",[]],[15,\"class\",\"logo-link\"],[13],[0,\"Upload Cover \"],[11,\"br\",[]],[13],[14],[0,\"Photo\"],[14],[0,\"\\n        \"],[14],[0,\"\\n      \"],[14],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"two-input-row\"],[13],[0,\"\\n        \"],[11,\"div\",[]],[15,\"class\",\"input-row-left\"],[13],[0,\"\\n          \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par-double par-left\"],[13],[0,\"Category\"],[14],[0,\"\\n          \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"restaurantCategory\"]],\"restaurant-input input-left\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n          \"],[11,\"div\",[]],[15,\"class\",\"error error-admin\"],[13],[1,[26,[\"errorCategory\"]],false],[14],[0,\"\\n        \"],[14],[0,\"\\n        \"],[11,\"div\",[]],[15,\"class\",\"input-row-right\"],[13],[0,\"\\n          \"],[11,\"p\",[]],[15,\"class\",\"add-restaurant-par-double par-right\"],[13],[0,\"Location\"],[14],[0,\"\\n          \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"restaurantLocation\"]],\"restaurant-input input-right\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n        \"],[14],[0,\"\\n      \"],[14],[0,\"\\n\\n  \"],[14],[0,\"\\n\\n\"],[14],[0,\"\\n\"]],\"locals\":[]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "e-restaurant-fe/templates/components/restaurant-basic.hbs" } });
});
define("e-restaurant-fe/templates/components/restaurant-menu", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "MbPOWG35", "block": "{\"statements\":[[6,[\"if\"],[[28,[\"enabled\"]]],null,{\"statements\":[[0,\"  \"],[11,\"div\",[]],[15,\"class\",\"row-add-restaurant\"],[13],[0,\"\\n    \"],[11,\"div\",[]],[15,\"class\",\"add-restaurant-menu\"],[13],[0,\"\\n    \"],[11,\"ul\",[]],[15,\"class\",\"nav navbar-nav nav-add-restaurant\"],[13],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item\"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableBreakfast\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openBreakfast\"]],[13],[0,\"Breakfast\"],[14],[14],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item\"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableLunch\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openLunch\"]],[13],[0,\"Lunch\"],[14],[14],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item \"],[13],[11,\"a\",[]],[16,\"class\",[34,[\"restaurant-menu-item \",[33,[\"if\"],[[28,[\"enableDinner\"]],\"active-item\"],null]]]],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"openDinner\"]],[13],[0,\"Dinner\"],[14],[14],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item \"],[13],[11,\"a\",[]],[15,\"class\",\"restaurant-menu-item add-item\"],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"addItem\"]],[13],[0,\"Add item\"],[14],[14],[0,\"\\n    \"],[14],[0,\"\\n  \"],[14],[0,\"\\n\\n\"],[6,[\"if\"],[[28,[\"enableBreakfast\"]]],null,{\"statements\":[[6,[\"each\"],[[28,[\"newBreakfast\"]]],null,{\"statements\":[[0,\"    \"],[11,\"div\",[]],[15,\"class\",\"menu-input-div\"],[13],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"input-row\"],[13],[0,\"\\n\\n        \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"name\"]],\"menu-input\",\"this.placeholder = ''\",\"Name\",\"text\"]]],false],[0,\"\\n        \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"price\"]],\"price-input\",\"this.placeholder=''\",\"$ Price\",\"text\"]]],false],[0,\"\\n          \"],[11,\"a\",[]],[5,[\"action\"],[[28,[null]],\"deleteItem\",[28,[\"item\"]]]],[13],[11,\"i\",[]],[15,\"class\",\"glyphicon glyphicon-trash delete-item\"],[13],[14],[14],[0,\"\\n      \"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"description\"]],\"menu-input\",\"this.placeholder = ''\",\"Description\",\"text\"]]],false],[0,\"\\n    \"],[14],[0,\"\\n\"]],\"locals\":[\"item\"]},null]],\"locals\":[]},null],[0,\"\\n\"],[6,[\"if\"],[[28,[\"enableLunch\"]]],null,{\"statements\":[[6,[\"each\"],[[28,[\"lunch\"]]],null,{\"statements\":[[0,\"      \"],[11,\"div\",[]],[15,\"class\",\"menu-input-div\"],[13],[0,\"\\n        \"],[11,\"div\",[]],[15,\"class\",\"input-row\"],[13],[0,\"\\n          \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"name\"]],\"menu-input\",\"this.placeholder = ''\",\"Name\",\"text\"]]],false],[0,\"\\n          \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"price\"]],\"price-input\",\"this.placeholder=''\",\"$ Price\",\"text\"]]],false],[0,\"\\n            \"],[11,\"a\",[]],[5,[\"action\"],[[28,[null]],\"deleteItem\",[28,[\"item\"]]]],[13],[11,\"i\",[]],[15,\"class\",\"glyphicon glyphicon-trash delete-item\"],[13],[14],[14],[0,\"\\n        \"],[14],[0,\"\\n        \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"description\"]],\"menu-input\",\"this.placeholder = ''\",\"Description\",\"text\"]]],false],[0,\"\\n      \"],[14],[0,\"\\n\"]],\"locals\":[\"item\",\"index\"]},null]],\"locals\":[]},null],[0,\"\\n\"],[6,[\"if\"],[[28,[\"enableDinner\"]]],null,{\"statements\":[[6,[\"each\"],[[28,[\"dinner\"]]],null,{\"statements\":[[0,\"        \"],[11,\"div\",[]],[15,\"class\",\"menu-input-div\"],[13],[0,\"\\n          \"],[11,\"div\",[]],[15,\"class\",\"input-row\"],[13],[0,\"\\n            \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"name\"]],\"menu-input\",\"this.placeholder = ''\",\"Name\",\"text\"]]],false],[0,\"\\n            \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"price\"]],\"price-input\",\"this.placeholder=''\",\"$ Price\",\"text\"]]],false],[0,\"\\n              \"],[11,\"a\",[]],[5,[\"action\"],[[28,[null]],\"deleteItem\",[28,[\"item\"]]]],[13],[11,\"i\",[]],[15,\"class\",\"glyphicon glyphicon-trash delete-item\"],[13],[14],[14],[0,\"\\n          \"],[14],[0,\"\\n          \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"item\",\"description\"]],\"menu-input\",\"this.placeholder = ''\",\"Description\",\"text\"]]],false],[0,\"\\n        \"],[14],[0,\"\\n\"]],\"locals\":[\"item\",\"index\"]},null]],\"locals\":[]},null],[0,\"  \"],[14],[0,\"\\n\"]],\"locals\":[]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "e-restaurant-fe/templates/components/restaurant-menu.hbs" } });
});
define("e-restaurant-fe/templates/components/restaurant-tables", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "Xu40Fl8e", "block": "{\"statements\":[[6,[\"if\"],[[28,[\"enabled\"]]],null,{\"statements\":[[0,\"  \"],[11,\"div\",[]],[15,\"class\",\"row-add-restaurant\"],[13],[0,\"\\n\\n    \"],[11,\"div\",[]],[15,\"class\",\"add-restaurant-menu\"],[13],[0,\"\\n    \"],[11,\"ul\",[]],[15,\"class\",\"nav navbar-nav nav-add-restaurant\"],[13],[0,\"\\n        \"],[11,\"li\",[]],[15,\"class\",\"nav-item \"],[13],[11,\"a\",[]],[15,\"class\",\"restaurant-menu-item add-item\"],[15,\"href\",\"#\"],[5,[\"action\"],[[28,[null]],\"addItem\"]],[13],[0,\"Add item\"],[14],[14],[0,\"\\n    \"],[14],[0,\"\\n  \"],[14],[0,\"\\n\"],[6,[\"each\"],[[28,[\"tables\"]]],null,{\"statements\":[[0,\"        \"],[11,\"div\",[]],[15,\"class\",\"table-input-div\"],[13],[0,\"\\n\\n          \"],[11,\"div\",[]],[15,\"class\",\"input-row\"],[13],[0,\"\\n            \"],[11,\"select\",[]],[15,\"class\",\"select-tables\"],[13],[0,\"\\n                \"],[11,\"option\",[]],[15,\"value\",\"1\"],[13],[0,\"Table for 1 person\"],[14],[0,\"\\n                \"],[11,\"option\",[]],[15,\"value\",\"2\"],[15,\"selected\",\"\"],[13],[0,\"Table for 2 persons\"],[14],[0,\"\\n                \"],[11,\"option\",[]],[15,\"value\",\"3\"],[13],[0,\"Table for 3 persons\"],[14],[0,\"\\n                \"],[11,\"option\",[]],[15,\"value\",\"4\"],[13],[0,\"Table for 4 persons\"],[14],[0,\"\\n                \"],[11,\"option\",[]],[15,\"value\",\"5\"],[13],[0,\"Table for 5 persons\"],[14],[0,\"\\n            \"],[14],[0,\"\\n            \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"placeholder\",\"type\"],[[28,[\"table\",\"amount\"]],\"amount-input\",\"this.placeholder=''\",\"Amount\",\"text\"]]],false],[0,\"\\n\\n          \"],[14],[0,\"\\n          \"],[14],[0,\"\\n\"]],\"locals\":[\"table\"]},null],[0,\"\\n  \"],[14],[0,\"\\n\"]],\"locals\":[]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "e-restaurant-fe/templates/components/restaurant-tables.hbs" } });
});
...
define('e-restaurant-fe/config/environment', ['ember'], function(Ember) {
  var exports = {'default': {"modulePrefix":"e-restaurant-fe","environment":"development","rootURL":"/","locationType":"auto","EmberENV":{"FEATURES":{},"EXTEND_PROTOTYPES":{"Date":false}},"APP":{"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"e-restaurant-fe","version":"0.0.0+386689d8"},"googleMap":{"apiKey":"AIzaSyCQKiuoytD_QzAJBrVYiQtit3E-L-zya7E"},"API_HOST":"http://localhost:9000","API_VERSION":"1","exportApplicationGlobal":true}};Object.defineProperty(exports, '__esModule', {value: true});return exports;
});

if (!runningTests) {
  require("e-restaurant-fe/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"e-restaurant-fe","version":"0.0.0+386689d8"});
}
