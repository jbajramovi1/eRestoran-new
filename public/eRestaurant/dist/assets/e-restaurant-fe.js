  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      addUser: function addUser() {
        ...
        this.get('adminService').updateUser(this.get('firstName'), this.get('lastName'), this.get('email'), this.get('password'), this.get('phone'), this.get('country'), this.get('city')).done(function (response) {
...
define('e-restaurant-fe/components/update-user', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = Ember.Component.extend({
    ...
    actions: {
      addUser: function addUser() {
        ...
        this.get('adminService').updateUser(this.get('userId'), this.get('user.firstName'), this.get('user.lastName'), this.get('user.email'), this.get('user.password'), this.get('user.phone'), this.get('user.country'), this.get('user.city')).done(function (response) {
          _this.get('notifications').success('Successfully updated user!', {
            autoClear: true,
            clearDuration: 1500
          });
          _this.get('adminpanel').set('userId', null);
          _this.get('adminpanel').send('refreshModel');
          _this.get('adminpanel').send('openUsers');
        }).fail(function (response) {
          var data = $.parseJSON(response.responseText);
          ...
          _this.get('notifications').error("Error occured while updating user!", {
            autoClear: true,
            clearDuration: 1500
          });
        });
...
define('e-restaurant-fe/controllers/adminpanel', ['exports'], function (exports) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      openUpdateUser: function openUpdateUser() {
        this.set('enableDashboard', false);
        this.set('enableRestaurants', false);
        this.set('enableAddRestaurant', false);
        this.set('enableLocations', false);
...
define('e-restaurant-fe/services/admin-service', ['exports'], function (exports) {
  ...
  exports.default = Ember.Service.extend({
    ...
    updateUser: function updateUser(id, firstName, lastName, email, password, phone, country, city) {
      return $.ajax({
        method: 'PUT',
...
define("e-restaurant-fe/templates/components/update-user", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "KDIhg9la", "block": "{\"statements\":[[6,[\"if\"],[[28,[\"enabled\"]]],null,{\"statements\":[[11,\"div\",[]],[15,\"class\",\"add-user-panel\"],[13],[0,\"\\n  \"],[11,\"div\",[]],[15,\"class\",\"user-info-input\"],[13],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"First Name\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"firstName\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"Last Name\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"lastName\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"Email\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"email\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"error\"],[13],[1,[26,[\"errorEmail\"]],false],[14],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"Password\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"password\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"error\"],[13],[1,[26,[\"errorPassword\"]],false],[14],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"Phone\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"phone\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"Country\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"country\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"p\",[]],[15,\"class\",\"add-user-par\"],[13],[0,\"City\"],[14],[0,\"\\n      \"],[1,[33,[\"input\"],null,[[\"value\",\"class\",\"onfocus\",\"type\"],[[28,[\"user\",\"city\"]],\"user-input\",\"this.placeholder = ''\",\"text\"]]],false],[0,\"\\n      \"],[11,\"button\",[]],[15,\"class\",\"button-add create-user-btn\"],[5,[\"action\"],[[28,[null]],\"updateUser\"]],[13],[0,\"Update user info\"],[14],[0,\"\\n    \"],[14],[0,\"\\n\"],[14],[0,\"\\n\"]],\"locals\":[]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "e-restaurant-fe/templates/components/update-user.hbs" } });
});
